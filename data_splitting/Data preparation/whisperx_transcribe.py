...
def transcribe_and_align_audio_files(input_dir, output_dir, model_size="large-v2", batch_size=16, compute_type="float16"):
    """
    Transcribes and aligns all audio files in `input_dir` and saves results in `output_dir`.
    ...
    for filename in tqdm(os.listdir(input_dir)):
        if filename.endswith(".mp3") or filename.endswith(".wav"):
           ...
           # print("Transcription (after alignment):", result["segments"])
...
if __name__ == "__main__":
    ...
    output_directory = "/home/ACG/data/raw/whisperx_transcripts"

    # Transcribe and align audio files
    transcribe_and_align_audio_files(input_directory, output_directory)
